...
import za.co.ajk.store.domain.Authority;
import za.co.ajk.store.domain.User;
import za.co.ajk.store.repository.AuthorityRepository;
import za.co.ajk.store.repository.UserRepository;
import za.co.ajk.store.security.AuthoritiesConstants;
import za.co.ajk.store.service.MailService;
import za.co.ajk.store.service.UserService;
import za.co.ajk.store.service.dto.UserDTO;
import za.co.ajk.store.web.rest.vm.ManagedUserVM;
