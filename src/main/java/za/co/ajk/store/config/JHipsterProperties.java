...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hipsterstore@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hipsterstore API";

        private String description = "hipsterstore API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "hipsterstore";
